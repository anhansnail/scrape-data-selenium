...
BASE_URL = "http://trungtamdichvuvieclam.bacninh.gov.vn"
headers = {
...
all_data = []
start_page = 1
end_page = 10  # <-- có thể tăng khi ổn định
...
df.to_excel(f"vieclam_trungtamdichvuvieclam_bacninh_p{start_page}_to_p{end_page}.xlsx", index=False)
